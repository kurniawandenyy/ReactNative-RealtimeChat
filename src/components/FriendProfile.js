          ...
          <View style={styles.row}>
            ...
            <View style={styles.column2}>
              <View style={styles.detail}>
                ...
                <Text style={styles.detailBody}>{this.props.datas[0]}</Text>
              </View>
            </View>
          </View>
          <View style={styles.row}>
            ...
            <View style={styles.column2}>
              <View style={styles.detail}>
                ...
                <Text style={styles.detailBody}>{this.props.datas[1]}</Text>
              </View>
            </View>
          </View>
          <View style={styles.row}>
            ...
            <View style={styles.column2}>
              <View style={styles.detail}>
                ...
                <Text style={styles.detailBody}>{this.props.datas[2]}</Text>
              </View>
            </View>
          </View>
        </ScrollView>
